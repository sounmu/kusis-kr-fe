    ...
    const events = [
        {
            ...
            title: '1학기 정의장학금(면학 및 미래로) 1차 신청',
            colorIndex: 0
        },
        {
            id: '2',
        ...
        },
        {
            ...
            endDate: new Date(2025, 1, 26),
            title: '1학기 신입·편입생(외국인전형) 및 학사학위 취득 유예생 수강신청',
            colorIndex: 6
        },
        {
            id: '8',
        ...
        },
        {
            ...
            title: '2학기 신입·편입생(외국인전형 포함) 및 학사학위 취득유예생 수강신청',
            colorIndex: 1
        },
        {
            id: '33',
        ...
        },
        {
            ...
            title: '자전 새내기새로배움터',
            colorIndex: 3,
            link: "https://instagram.com/kusis_freshman"
        }
    ];
